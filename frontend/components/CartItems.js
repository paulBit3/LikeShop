...
/* This component will display item in the cart. it passes a checkout boolean value
It will allow the user to view and update items currently in their cart
 */
...
export default function CartItems (props) {
    ...
    //this method will use removeItem helper method to remove
    //the item form the cartin the local storage, then update 
    //the cart items
    const removeItem = index => e => {
        let updatedCart = cart.removeItem(i)
    ...
    //this methof will use the setCheckout method passed as prop to set the chekout
    //value to true in the cart view component.
    const openCheckout = () => {
